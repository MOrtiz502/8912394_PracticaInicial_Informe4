...
class CatedraticoController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query("select idCatedratico, CONCAT(Nombre,' ',Apellido) as Nombre from catedratico order by Nombre, Apellido", '', function (err, result, fields) {
                if (err)
                    throw err;
                if (result.length > 0) {
                    res.json(result);
